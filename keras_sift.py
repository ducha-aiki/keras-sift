...
import numpy as np
import math
os.environ["THEANO_FLAGS"] = "mode=FAST_RUN,device=cpu,floatX=float32, cuda.root=/usr/local/cuda/, lib.cnmem=0.5 "
...
def get_sift_model(inputs, img_rows = 65, num_ang_bins = 8, num_spatial_bins = 4, clipval = 0.2):
